...
export const makeInvoice = async (setText: any) => {
...
function replaceKeysWithPrefix(obj: any, str: string) {
  const regex = new RegExp(`@(${Object.keys(obj).join('|')})(?=\\b|\\s)`, 'g');
  const parts = str.split(/(\s+)/);
  const replacedParts = parts.map((part: any) =>
...
export const handleSubmitText = async (
  ...
  pubSuccessCallback?: (eventId: any, relayUrl: any) => any,
